    ...
    if (o.extend = function(e, t) {
        ...
        var A = S.API = {
            ajax: function(e, t, i, r, n) {
                ...
                var y = "cb_" + Math.round(1000000 * Math.random());
                A[y] = function(e) {
                    switch (e.code) {
                        case 0:
                            r && r(e);
                    ...
                    if (m) {
                        try {
                            m.removeItem(e),
                                ...
                                m[e + ":timestamp"] = Math.floor((new Date - b) / 1000)
                        } catch (s) {}
                    }
                }
            }
        ...
        var Z = {
                ...
                avatarUrl: function(e) {
                    var avatar_url = e.avatar_url;
                    if (!avatar_url) {
                        if (rt.data.default_avatar_url.indexOf("http:")) {
            ...
            S.require("embed.compat", function() {
                ...
                function x(e, t, s, a) {
                    function i() {
                        ...
                        return a || l.find("[type=checkbox]:checked")[0] ? (A.post("posts/repost", S.toJSON(l), e),
                            o.close(),
                            !1) : (alert("还没有选发布到哪儿呢"),
                            !1)
                    }
                    ...
                    function o() {
                        ...
                        if (a.hasClass("ds-reply-active")) {
                            ...
                            h ? h.actionsBar.removeClass("ds-reply-active") : (h = new st.Replybox(e),
                                ...
                                h.postList[0] || (h.postList = B('<ul class="ds-children"></ul>').insertAfter(i)))
                        }
                        return !1
                    }
                    function d() {
                        function e(e) {
                            W(e),
                                i.append(B.map(e.response, function(e) {
                                    return et.post({
                                        post: e,
                                        options: t
                                    })
                        ...
                        return i[0] ? (i.remove(),
                            !1) : (i = B('<ul class="ds-children"></ul>').insertAfter(s),
                            A.get("posts/listComments", H({
                                post_id: a
                            }), e),
                            !1)
                    }
                ...
                e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)),
                    S.scrollTo = function(e) {
                        var t = e.offset().top;
                        (t < V.scrollTop() || t > V.scrollTop() + V.height()) && B("html, body").animate({
                            scrollTop: t - 40
                        }, 200, "swing")
                    }
                    ,
                    ...
                    st.Replybox.prototype = {
                        render: function(e) {
                            ...
                            var q = function(e) {
                                    s(b),
                                        A.post("posts/create", B.extend(S.toJSON(b), e), function(e) {
                    ...
                    st.Dialog = J.extend({
                        init: function(e, t) {
                            (this.el = B("#ds-wrapper"))[0] || (this.el = p(B('<div id="ds-wrapper"></div>'))),
                    ...
                    st.EmbedThread = Q.extend({
                        ...
                        onload: function(t) {
                            ...
                            c.postList = a.postList.el,
                                r() ? a.loginButtons = B(et.loginButtons()).delegate("a.ds-more-services", "click", function() {
                            ...
                            "bottom" == o.formPosition && B.fn.append.apply(d, u),
                                ...
                                a.updateCounter(),
                            t.alerts && B.each(t.alerts, function(e, t) {
                            ...
                            o.mzadx_id && (S.require("mzadxN", function() {}),
                                B('<div id="MZADX_' + o.mzadx_id + '" style="margin:0 auto;"></div>').appendTo(d),
                                __mz_rpq = e.__mz_rpq || [],
                                __mz_rpq.push({
                                    l: [o.mzadx_id],
                                    r: "1",
